...
results <- do.call(rbind, pbmclapply(1:B, function(b){
  bootstrap_gee(p = combinations2boot[b, p],
                n = combinations2boot[b, n],
                sick_obs_percentage = combinations2boot[b, sick_obs_percentage],
                t_length = combinations2boot[b, t_length],
